...
function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    // Optional: Stop them if they just typed a bunch of empty spaces
    if (!cleanUsername) {
    ...
    try {
      ...
      let attestation;
      try {
        // --- FIX 2: Pass the options inside the { optionsJSON } wrapper for v13 ---
      ...
      if (result.success) {
        ...
        // User is NOT automatically logged in - they need to authenticate via login
        setTimeout(() => {
          navigate("/login");
        }, 2000);
      ...
      <div className='w-full max-w-[400px]'>
        <div className='text-center mb-8'>
          ...
          <p className='mt-2 text-sm text-gray-500'>
            Register with a biometric device or key
          </p>
        </div>
